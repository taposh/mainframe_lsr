...
namespace WCIRB.LSRMFBridgeTests
{
    ...
    /// CDC_CARRIER to InsurerTPELocationMap table 
    /// </summary>
    [TestFixture]
    public class InsurerTPELocationMapTests : NUnitBase
    {
        ...
        /// Default contructor
        /// </summary>
        public InsurerTPELocationMapTests()
        {
        }
        ...
        protected void SetUp()
        {
            ...
            try
            {
                ...
                carrierTestdataDoc.Load(TestConstants.CONST_INSERTS_TEST_DATA_XML_DOC);
